...
@WebFilter(urlPatterns="/site/cadastro/")
//@WebFilter(urlPatterns="/site/central/")
public class FiltroSegurancaCadastro implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		try {
	       ...
	       if (  (ses != null && ses.getAttribute("usuario") != null && ses.getAttribute("senha") != null)
	                                  || reqURI.indexOf("/site/cadastro/") >= 0 && reqURI.contains("javax.faces.resource") )
